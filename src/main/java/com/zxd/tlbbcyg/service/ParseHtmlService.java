package com.zxd.tlbbcyg.service;
...
public class ParseHtmlService {
    ...
    public String update(String price, String totalPage){
    ...
    public String updatetangm(String price, String totalPage){
    ...
    public String updatetaohua(String price, String totalPage){
    ...
    public String updateemei(String price, String totalPage){
        String url = "http://tl.cyg.changyou.com/goods/selling?world_id=0&profession=13&price=1-" + price + "&have_chosen=price*1-400%20profession*8&page_num=";
    ...
    public String updateguigu(String price, String totalPage){
    ...
    public String updatetianlong(String price, String totalPage){
        String url = "http://tl.cyg.changyou.com/goods/selling?world_id=0&profession=12&price=1-" + price + "&have_chosen=price*1-400%20profession*8&page_num=";
    ...
    public String updateAll(String price, String totalPage){
